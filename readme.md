...
```json
{
	...
	"eslintConfig": {
		...
		"rules": {
			...
			"unicorn/no-useless-interpolation": "error",
...
| [no-useless-interpolation](docs/rules/no-useless-interpolation.md) | Forbid useless interpolation in template strings. | ✅ | 🔧 |  |
